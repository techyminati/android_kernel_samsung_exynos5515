...
#define IOVA_VSS_FIRMWARE_NOCP		(0xA0300000)
...
#define ABOX_QUIRK_BIT_WEARABLE_MODE	BIT(3)
#define ABOX_QUIRK_STR_WEARABLE_MODE	"wearable mode"
...
//	struct clk *clk_dmic;
	...
	struct abox_weak_route weak_route;
};
...
/**
 * get debug level
 * @return		debug_level hex value about low/mid/high
 */
extern unsigned int abox_get_debug_level(void);
#endif
