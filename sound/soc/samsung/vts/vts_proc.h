 ...
 * @return	entry to the file
 */
extern struct proc_dir_entry *vts_proc_create_bin(const char *name,
		umode_t mode, struct proc_dir_entry *parent,
		struct vts_proc_bin *bin);
 ...
 * @return	entry to the file
 */
extern struct proc_dir_entry *vts_proc_create_u64(const char *name,
 ...
 * @return	entry to the file
 */
extern struct proc_dir_entry *vts_proc_create_u32(const char *name,
 ...
 * @return	entry to the file
 */
extern struct proc_dir_entry *vts_proc_create_bool(const char *name,
