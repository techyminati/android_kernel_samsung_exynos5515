...
#define SOUND_MODEL_GOOGLE_OFFSET	(0x32B00)
...
#define LOG_BUFFER_BYTES_MAX	(0x2000)	// VTS FW debug.h g_LOG_SRAM_SIZE x 2
#define VTS_SRAMLOG_MSGS_OFFSET (0x70000)	// VTS FW debug.h PrintLog_BaseAddr
...
#elif IS_ENABLED(CONFIG_SOC_S5E9815)
#define VTSFW_VERSION_OFFSET	(0xbc)
#define DETLIB_VERSION_OFFSET	(0xb8)
#elif IS_ENABLED(CONFIG_SOC_S5E5515)
#define VTSFW_VERSION_OFFSET	(0xac)
#define DETLIB_VERSION_OFFSET	(0xa8)
#else
...
enum poll_event_type {
	EVENT_NONE              = 0,
	EVENT_TRIGGERED         = 0x1,
	EVENT_STOP_POLLING      = 0x2,
	EVENT_ERROR_RECOVERY    = 0x4,
	EVENT_READY             = 0x10,
};
...
struct vts_data {
	...
	unsigned long sysclk_origin_rate;
	...
	enum vts_rec_state_machine vts_rec_state;
	enum vts_tri_state_machine vts_tri_state;
...
extern bool vts_runtime_get_sync(void);
extern bool vts_runtime_put_sync(void);
