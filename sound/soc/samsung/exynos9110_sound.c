/*
 *  Driver for Madera CODECs on Exynos9110
 *
...
static const struct snd_soc_dapm_widget exynos9110_supply_widgets[] = {
...
static int exynos9110_probe(struct snd_soc_card *card)
{
	int i;

	for (i = 0; i < ARRAY_SIZE(exynos9110_supply_widgets); i++) {
		const struct snd_soc_dapm_widget *w;
		struct regulator *r;

		w = &exynos9110_supply_widgets[i];
		switch (w->id) {
...
static struct snd_soc_dai_link exynos9110_dai[100] = {
	{
		.name = "RDMA0",
		.stream_name = "RDMA0",
		.dynamic = 1,
...
static const struct snd_soc_dapm_widget exynos9110_widgets[] = {
...
static const struct snd_soc_dapm_route exynos9110_routes[] = {
...
static struct snd_soc_card exynos9110_madera = {
	.name = "Exynos9110-Madera",
	.owner = THIS_MODULE,
	.dai_link = exynos9110_dai,
	.num_links = ARRAY_SIZE(exynos9110_dai),

	.probe = exynos9110_probe,
	...
	.dapm_routes = exynos9110_routes,
	.num_dapm_routes = ARRAY_SIZE(exynos9110_routes),
...
{
	struct snd_soc_card *card = &exynos9110_madera;
	int ret;
...
static int exynos9110_audio_remove(struct platform_device *pdev)
{
...
static const struct of_device_id exynos9110_audio_of_match[] = {
	{ .compatible = "samsung,exynos9110-madera", },
	{},
};
MODULE_DEVICE_TABLE(of, exynos9110_audio_of_match);
#endif /* CONFIG_OF */

static struct platform_driver exynos9110_audio_driver = {
	.driver		= {
		.name	= "exynos9110-audio",
		.owner	= THIS_MODULE,
		.pm = &snd_soc_pm_ops,
		.of_match_table = of_match_ptr(exynos9110_audio_of_match),
	},

	.probe		= exynos9110_audio_probe,
	.remove		= exynos9110_audio_remove,
};

module_platform_driver(exynos9110_audio_driver);

MODULE_DESCRIPTION("ALSA SoC Exynos9110 Audio Driver");
MODULE_AUTHOR("Charles Keepax <ckeepax@opensource.wolfsonmicro.com>");
MODULE_AUTHOR("Gyeongtaek Lee <gt82.lee@samsung.com>");
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:exynos9110-madera");
