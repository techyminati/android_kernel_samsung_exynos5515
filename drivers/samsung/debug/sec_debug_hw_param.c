...
#endif
	/* ASV : TG-CPU0-MIF-INT-G3D-DISP-AUD */
	info_size +=
		snprintf((char *)(buf + info_size), DATA_SIZE - info_size,
				"\"ASV\":\"%d-%d-%d-%d-%d-%d-%d\",", asv_ids_information(tg),
				asv_ids_information(lg), asv_ids_information(mifg), asv_ids_information(intg),
				asv_ids_information(g3dg), asv_ids_information(dispg), asv_ids_information(audg));

	info_size +=
		snprintf((char *)(buf + info_size), DATA_SIZE - info_size,
				"\"IDS\":\"%d\",", asv_ids_information(lids));
