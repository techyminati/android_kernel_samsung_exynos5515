...
static int __init get_big_volt(char *str)
{
	...
	get_option(&str, &volt);
	init_margin_table[MARGIN_CPUCL2] = volt;
...
static int __init get_mid_volt(char *str)
{
	...
	get_option(&str, &volt);
	init_margin_table[MARGIN_CPUCL1] = volt;
...
static int __init get_lit_volt(char *str)
{
	...
	get_option(&str, &volt);
	init_margin_table[MARGIN_CPUCL0] = volt;
...
static int __init get_gnss_volt(char *str)
{
	int volt;

	get_option(&str, &volt);
	init_margin_table[MARGIN_GNSS] = volt;

	return 0;
}
early_param("gnss", get_gnss_volt);
...
static int __init get_dsu_volt(char *str)
{
	int volt;

	get_option(&str, &volt);
	init_margin_table[MARGIN_DSU] = volt;

	return 0;
}
early_param("dsu", get_dsu_volt);

static int __init get_vpc_volt(char *str)
{
	int volt;

	get_option(&str, &volt);
	init_margin_table[MARGIN_VPC] = volt;

	return 0;
}
early_param("vpc", get_vpc_volt);

static int __init get_modem_volt(char *str)
{
	int volt;

	get_option(&str, &volt);
	init_margin_table[MARGIN_MODEM] = volt;

	return 0;
}
early_param("modem", get_modem_volt);

/*static int __init get_intsci_volt(char *str)
{
	int volt;

	get_option(&str, &volt);
	init_margin_table[MARGIN_INTSCI] = volt;

	return 0;
}
early_param("intsci", get_intsci_volt);*/

static int __init get_csis_volt(char *str)
{
	int volt;

	get_option(&str, &volt);
	init_margin_table[MARGIN_CSIS] = volt;

	return 0;
}
early_param("csis", get_csis_volt);
...
int fvmap_init(void __iomem *sram_base)
{
	...
	pr_info("%s:fvmap initialize: done\n", __func__);
