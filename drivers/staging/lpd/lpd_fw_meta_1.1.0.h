...
#define LPD_METADATA_API_VERSION		_VERSION(1, 1, 1)
...
enum lpd_sensor_id {
	LPD_DATA_ID_DURATION = 0,
	LPD_DATA_ID_CAL,
	LPD_DATA_ID_CUR_HEART,
	LPD_DATA_ID_AVG_HEART,
	LPD_DATA_ID_MAX_HEART,
	LPD_DATA_ID_CUR_SPEED,
	LPD_DATA_ID_AVG_SPEED,
	LPD_DATA_ID_CUR_PACE,
	LPD_DATA_ID_AVG_PACE,
	LPD_DATA_ID_DISTANCE,
	LPD_DATA_ID_STEP,
	LPD_DATA_ID_CADENCE,
	LPD_DATA_ID_ELEVATION,
	LPD_DATA_ID_LENGTH,
	LPD_DATA_ID_LAST_STROKE,
	LPD_DATA_ID_TOTAL_STROKE,
} __attribute__((packed));
