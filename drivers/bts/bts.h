...
#define TICK_GRANULARITY_S0_RESET	0x00000010
#define TICK_GRANULARITY_S1_RESET	0x00000010
...
#define EMERGENT_CONFIG_R_RESET	0x00FF0000
#define EMERGENT_CONFIG_W_RESET 0x00FF0000

#define PF_TOKEN_CONTROL_RESET		0x0000000F
#define PF_TOKEN_THRESHOLD_RESET	0x00040104
#define PF_TICK_GRANULARITY_S0_RESET	0x00000010
#define PF_TICK_GRANULARITY_S1_RESET	0x00000010
...
struct bts_ops {
	...
	int		(*set_emergent_config)(void __iomem *va, struct bts_stat *stat);
	int		(*get_emergent_config)(void __iomem *va, struct bts_stat *stat);

	int		(*set_pf_token)(void __iomem *va, struct bts_stat *stat);
	int		(*get_pf_token)(void __iomem *va, struct bts_stat *stat);
...
struct bts_stat {
	...
	unsigned int		emergent_config_r;
	unsigned int 		emergent_config_w;

	bool			drex_pf_on;
	unsigned int		pf_rreq_thrt_con;
	unsigned int		allow_mo_for_region;
	unsigned int		pf_token_control;
	unsigned int		pf_token_threshold;
