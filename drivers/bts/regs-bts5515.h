...
#define CON			0x000
#define TIMEOUT_CNT_R0		0x008
#define TIMEOUT_CNT_W0		0x010
#define RCON			0x020
...
#define EMERGENT_CONFIG_R	0x384
#define EMERGENT_CONFIG_W	0x388
...
#define PORT_TOKEN_CUTOFF_EN0	0
#define PORT_TOKEN_CUTOFF_EN1	1
#define PORT_TOKEN_CUTOFF_EN2	2
#define PORT_TOKEN_CUTOFF_EN3	3
#define PORT_TOKEN_THRESHOLD_P3	24
#define PORT_TOKEN_THRESHOLD_P2	16
#define PORT_TOKEN_THRESHOLD_P1	8
#define PORT_TOKEN_THRESHOLD_P0	0
