...
#if defined(CONFIG_EXYNOS_LPD)
static int init_lpd_dpu_info(struct decon_device *decon)
{
	struct lpd_dpu_info *dpu_info;
	struct lpd_panel_info *lpd_panel;
	...
	dpu_info = &decon->lpd_dpu;
	lpd_panel = &dpu_info->panel;

	lpd_panel->id = decon->lcd_info->id;
	decon_info("lpd_panel->id : %x\n", lpd_panel->id);

	lpd_panel->xres = decon->lcd_info->xres;
	lpd_panel->yres = decon->lcd_info->yres;
	lpd_panel->fps = decon->lcd_info->fps;
	decon_info("lpd_panel->xres: %d, lpd_panel->yres: %d, lpd_panel->fps: %d\n",
		lpd_panel->xres, lpd_panel->yres, lpd_panel->fps);

	lpd_panel->hs_clk  = decon->lcd_info->hs_clk;
	lpd_panel->p = decon->lcd_info->dphy_pms.p;
	lpd_panel->m = decon->lcd_info->dphy_pms.m;
	lpd_panel->s = decon->lcd_info->dphy_pms.s;
	lpd_panel->k = decon->lcd_info->dphy_pms.k;
	decon_info("lpd_panel->hs_clk: %d, lpd_panel->p: %d, lpd_panel->m: %d, lpd_panel->s: %d, lpd_panel->: %d\n",
		lpd_panel->hs_clk, lpd_panel->p, lpd_panel->m, lpd_panel->s, lpd_panel->k);
