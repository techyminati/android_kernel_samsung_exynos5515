/*
 * linux/drivers/video/fbdev/exynos/dpu_5515/regs_decon.h
 *
...
#define DISP_DPU_MIPI_PHY_CON           0x0
/* _v : [0,1] */
#define SEL_RESET_DPHY_MASK(_v)			(0x1 << (4 + (_v)))
#define M_RESETN_M2S0_TOP_MASK			(0x1 << 0)
 ...
 *
 * - CMU_DPU			0x1380_0000
 * - SYSREG_DPU			0x1386_0000
 * - SMMU_DPU_NS		0x1382_0000
 * - SMMU_DPU_S			0x1383_0000
 * - DPP				0x138B_0000
 * - DECON0				0x138C_0000
 * - DPU_DMA			0x138A_0000
 * - MIPI_DSIM0			0x138D_0000
 * - DCPHY_M2S0			0x138D_0000
 */
...
#define CLOCK_CONTROL_0_CG_MASK			((0x1 << 0) | (0x1 << 12) | (0x1 << 16))
