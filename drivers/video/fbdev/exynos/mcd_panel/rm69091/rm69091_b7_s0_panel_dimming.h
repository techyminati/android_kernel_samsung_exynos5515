/*
 * linux/drivers/video/fbdev/exynos/panel/s6e36w5x01/rm69091_b7_s0_panel_dimming.h
 *
...
#ifndef __RM69091_B7_S0_PANEL_DIMMING_H___
#define __RM69091_B7_S0_PANEL_DIMMING_H___
#include "../dimming.h"
 ...
 * PANEL : WISE_B7_S0
 */
#define RM69091_NR_STEP (256)
#define RM69091_HBM_STEP (1)
#define RM69091_TOTAL_STEP (RM69091_NR_STEP + RM69091_HBM_STEP)

static unsigned int rm69091_b7_s0_brt_tbl[RM69091_TOTAL_STEP] = {
...
static unsigned int rm69091_b7_s0_lum_tbl[RM69091_TOTAL_NR_LUMINANCE] = {
	/* normal 10x25+6 */
...
static unsigned int rm69091_b7_s0_step_cnt_tbl[RM69091_TOTAL_STEP] = {
	[0 ... RM69091_TOTAL_STEP - 1] = 1,
};

struct brightness_table rm69091_b7_s0_panel_brightness_table = {
	.control_type = BRIGHTNESS_CONTROL_TYPE_GAMMA_MODE2,
	.brt = rm69091_b7_s0_brt_tbl,
	.sz_brt = ARRAY_SIZE(rm69091_b7_s0_brt_tbl),
	.sz_ui_brt = RM69091_NR_STEP,
	.sz_hbm_brt = RM69091_HBM_STEP,
	.lum = rm69091_b7_s0_lum_tbl,
	.sz_lum = RM69091_TOTAL_NR_LUMINANCE,
	.sz_ui_lum = RM69091_NR_LUMINANCE,
	.sz_hbm_lum = RM69091_NR_HBM_LUMINANCE,
	.sz_ext_hbm_lum = 0,
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = rm69091_b7_s0_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(rm69091_b7_s0_step_cnt_tbl),
	.vtotal = 3232,
};

static struct panel_dimming_info rm69091_b7_s0_panel_dimming_info = {
	.name = "rm69091_b7_s0",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &rm69091_b7_s0_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,
	.hbm_aor = NULL,
 ...
 * PANEL : HEART_B7_S0
 */
#define RM69091_W5_NR_STEP (256)
#define RM69091_W5_HBM_STEP (45)
#define RM69091_W5_TOTAL_STEP (RM69091_W5_NR_STEP + RM69091_W5_HBM_STEP)

static unsigned int rm69091_w5_b7_s0_brt_tbl[RM69091_W5_TOTAL_STEP] = {
	BRT(0), BRT(1), BRT(2), BRT(3), BRT(4), BRT(5), BRT(6), BRT(7), BRT(8), BRT(9), BRT(10),
	BRT(11), BRT(12), BRT(13), BRT(14), BRT(15), BRT(16), BRT(17), BRT(18), BRT(19), BRT(20),
	BRT(21), BRT(22), BRT(23), BRT(24), BRT(25), BRT(26), BRT(27), BRT(28), BRT(29), BRT(30),
	BRT(31), BRT(32), BRT(33), BRT(34), BRT(35), BRT(36), BRT(37), BRT(38), BRT(39), BRT(40),
...
static unsigned int rm69091_w5_b7_s0_lum_tbl[RM69091_W5_TOTAL_NR_LUMINANCE] = {
	/* normal 10x25+6 */
	5, 5, 5, 7, 10, 12, 14, 17, 19, 21,
	24, 26, 28, 30, 33, 35, 37, 40, 42, 44,
	47, 49, 51, 54, 56, 58, 61, 63, 65, 68,
...
static unsigned int rm69091_w5_b7_s0_step_cnt_tbl[RM69091_W5_TOTAL_STEP] = {
	[0 ... RM69091_W5_TOTAL_STEP - 1] = 1,
};

struct brightness_table rm69091_w5_b7_s0_panel_brightness_table = {
	.control_type = BRIGHTNESS_CONTROL_TYPE_GAMMA_MODE2,
	.brt = rm69091_w5_b7_s0_brt_tbl,
	.sz_brt = ARRAY_SIZE(rm69091_w5_b7_s0_brt_tbl),
	.sz_ui_brt = RM69091_W5_NR_STEP,
	.sz_hbm_brt = RM69091_W5_HBM_STEP,
	.lum = rm69091_w5_b7_s0_lum_tbl,
	.sz_lum = RM69091_W5_TOTAL_NR_LUMINANCE,
	.sz_ui_lum = RM69091_W5_NR_LUMINANCE,
	.sz_hbm_lum = RM69091_W5_NR_HBM_LUMINANCE,
	.sz_ext_hbm_lum = 0,
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
	.step_cnt = rm69091_w5_b7_s0_step_cnt_tbl,
	.sz_step_cnt = ARRAY_SIZE(rm69091_w5_b7_s0_step_cnt_tbl),
	.vtotal = 3232,
};

static struct panel_dimming_info rm69091_w5_b7_s0_panel_dimming_info = {
	.name = "rm69091_w5_b7_s0",
	.dim_init_info = {
		NULL,
	},
	.target_luminance = -1,
	...
	.extend_hbm_target_luminance = -1,
	.nr_extend_hbm_luminance = 0,
	.brt_tbl = &rm69091_w5_b7_s0_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,
	.hbm_aor = NULL,
...
#endif /* __RM69091_B7_S0_PANEL_DIMMING_H___ */
