...
void panel_bl_init_brightness_set_count(struct panel_bl_device *panel_bl)
{
	atomic_set(&panel_bl->props.brightness_set_count, 2);
}
...
/* The default value is 1 to avoid unwanted actions after booting. */
	panel_bl_init_brightness_set_count(panel_bl);
