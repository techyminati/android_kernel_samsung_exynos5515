...
enum {
	PANEL_ISR_DISP_DET = 0,
	PANEL_ISR_PCD,
	PANEL_ISR_ERR_FG,
	PANEL_ISR_CONN_DET,
	PANEL_ISR_EVASION_DISP_DET,
	MAX_PANEL_ISR,
};

enum {
	PANEL_ISR_ACTION_RECOVERY = 0x01,
	PANEL_ISR_ACTION_POWERDOWN = 0x02,
	PANEL_ISR_ACTION_UBCONN_NOTIFY = 0x04,
	PANEL_ISR_ACTION_UBCONN_UEVENT = 0x08,
	PANEL_ISR_ACTION_UBCONN_ABC = 0x10,
	MAX_PANEL_ISR_ACTION,
};
...
#endif
	struct panel_test_key_info test_key;
};
...
struct panel_properties {
	...
	u32 yres;
	bool vrr_updated;
/* commented by minwoo7945.kim due to wise bringup */
