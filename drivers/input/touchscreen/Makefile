...
obj-$(CONFIG_TOUCHSCREEN_ZXT_ZTM620)	+= zxt_ztm620_ts_renaissance.o
obj-$(CONFIG_TOUCHSCREEN_ZINITIX_ZTM620)	+= zinitix/ztm620/
obj-$(CONFIG_TOUCHSCREEN_ZINITIX_ZTM630)	+= zinitix/ztm630/
obj-$(CONFIG_TOUCHSCREEN_ZINITIX_ZTM730)	+= zinitix/ztm730/
obj-$(CONFIG_TOUCHSCREEN_HIDEEP_IST207W) += hideep/
