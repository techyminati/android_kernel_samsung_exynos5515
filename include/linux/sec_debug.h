...
extern void secdbg_exin_set_main_ocp(void);
extern void secdbg_exin_set_sub_ocp(void);
...
#define secdbg_exin_get_unfz(a)		""
#define secdbg_exin_set_main_ocp()		do { } while (0)
#define secdbg_exin_set_sub_ocp()		do { } while (0)
...
#define secdbg_mode_enter_upload()	(0)
